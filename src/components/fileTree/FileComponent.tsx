...
export default function FileComponent({id, name, activeNode, changeActiveNodeHandler}:IFileProps) {
    return (
        <>
            <li className="block ml-1 mt-1 cursor-pointer" onClick={()=>{changeActiveNodeHandler(id)}}>
                <div className={ `${activeNode === id ? 'bg-[rgba(98,157,214)]' : ''} flex items-center gap-1`}>
