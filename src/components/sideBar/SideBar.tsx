// ** Interfaces
interface ISideBar{
    openFileTreeSideSectionHandler: ()=> void;
    openSearchSideSectionHandler: ()=> void;
}



export default function SideBar({openFileTreeSideSectionHandler, openSearchSideSectionHandler}:ISideBar) {
    return (
        <>
            <nav className="min-w-12 h-full flex flex-col justify-between items-center bg-[#333333] py-4">
                <ul className="flex flex-col items-center gap-6">
                    <li className="cursor-pointer" onClick={openFileTreeSideSectionHandler}>
                    ...
                    <li className="cursor-pointer" onClick={openSearchSideSectionHandler}>
